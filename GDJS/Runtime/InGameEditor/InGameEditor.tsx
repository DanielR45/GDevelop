namespace gdjs {
  ...
  class Toolbar {
    ...
    private addToolbarStyle() {
      if (document.getElementById('InGameEditor-Toolbar-Style')) {
        return;
      }
    ...
    render(parent: HTMLElement) {
      ...
      this._renderedElements.container.style.display = this._hasSelection() ? 'flex' : 'none';

      const transformControlsMode = this._getTransformControlsMode();
      this._renderedElements.freeCameraButton.classList.toggle('InGameEditor-Toolbar-Button-Active', this._isFreeCamera())
      this._renderedElements.orbitCameraButton.classList.toggle('InGameEditor-Toolbar-Button-Active', !this._isFreeCamera());
      this._renderedElements.moveButton.classList.toggle('InGameEditor-Toolbar-Button-Active', transformControlsMode === 'translate');
      this._renderedElements.rotateButton.classList.toggle('InGameEditor-Toolbar-Button-Active', transformControlsMode === 'rotate');
      this._renderedElements.scaleButton.classList.toggle('InGameEditor-Toolbar-Button-Active', transformControlsMode === 'scale');
    }
  }
